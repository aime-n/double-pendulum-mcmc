...
# Decrease the number of trail segments for a shorter trail
trail_length = 20
trail1_lines = [ax.plot([], [], 'r-', alpha=alpha)[0] for alpha in np.linspace(0.1, 1, trail_length)]
trail2_lines = [ax.plot([], [], 'b-', alpha=alpha)[0] for alpha in np.linspace(0.1, 1, trail_length)]
...
ani.save('output/double_pendulum_with_shorter_trail.gif', writer=PillowWriter(fps=fps))
